...
```{r}
knitr::include_graphics("http://course1.winona.edu/kbates/Immunology/images/figure_09_41.jpg")
```

```{r}
knitr::include_graphics("http://course1.winona.edu/kbates/Immunology/images/figure_09_43.jpg")
```
...
```{r}\knitr::include_graphics("https://cdn.rcsb.org/pdb101/motm/images/1hsa-1dlh.gif")
```
...
```{r}
knitr::include_graphics("figure/ab-mediated-killing.png")
```
...
.footer[Pilt: IFNbig gamma and lymphocytes prevent primary tumour development and shape tumour immunogenicity.
<a href="http://www.nature.com/nature/journal/v410/n6832/full/4101107a0.html">
Shankaran et al., 2001.
</a>
...
library(png)
a <- lapply(c("figure/proliferation_of_24D3_in_response-to_MethA.png",
       "figure/MethA_growth_is_sensitive_to_24D3.png",
       "figure/MethA_growth_is_not_sensitive_to_24D3.png"), readPNG)            
...
```{r}
knitr::include_graphics("http://www.nature.com/mt/journal/v18/n2/images/mt2009228f2.gif")
```
...
```{r}
knitr::include_graphics("figure/331_1540a_F1.jpg")
```
...
```{r}
knitr::include_graphics("figure/Screenshot2015-12-2109:42:03.png")
```
...
```{r}
knitr::include_graphics("figure/apl.png")
```
...
```{r}
knitr::include_graphics("figure/targeted-therapy.png")
```
...
```{r}
knitr::include_graphics("figure/prima1.png")
```
...
```{r}
knitr::include_graphics("figure/ICG001.png")
```
